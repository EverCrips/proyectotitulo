    ...
    <body onload="ejecutarModalFun()">
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Bienvenido al reporte de avisos</h1>                       
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-xl-6">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                ¿Necesitas informar al resto sobre algo?
                            </div>
                            <div class="panel-body">
                                <ul style="list-style-type:circle;">
                                    <li>Informativos</li>
                                    <li>Alertas</li>
                                    <li>Movimiento de equipos</li>
                                    <li>Editar</li>
                                    <li>Otros</li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fas fa-file"></i>  Formulario de avisos
                            ...
                            <div class="panel-body datosCuenta">  
                                <form method="post" action="servletEx" class="datosCuenta">
                                    <div class="row ">                                    
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                            <label>Nombre usuario</label>
                                            <input type="text" class="form-control" value="<%=((String) datosUs.get(0)).trim()%>" readonly="">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                            <label>Rut usuario</label>
                                            <input type="text" class="form-control" value="<%=((String) datosUs.get(1)).trim()%>" readonly="">
                                        </div>
                                    </div>
                                    <div class="row ">                                    
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 paddingDiv">
                                            <label>Correo usuario</label>
                                            <input name="emailUsAviso" type="text" class="form-control" value="<%=((String) datosUs.get(3)).trim()%>" readonly="">
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row ">                                    
                                        <div class="col-xs-12 col-sm-12 col-md-8 col-xl-8 paddingDiv">
                                            <label>Título aviso</label>
                                            <input type="text" class="form-control" name="tituloAviso" required="">
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-xl-4 paddingDiv">
                                            <label>Tipo</label>
                                            <select name="tipoAviso" class="form-control" required="">
                                    ...
                                    <div class="row ">                                    
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 paddingDiv">
                                            <label>Descripción aviso</label>
                                            <textarea class="form-control" name="descripcionAviso" rows="7" required="" placeholder="Descripción..."></textarea>
                                        </div>
                                    </div>
                                    <input type="hidden" name="opcion" value="enviarAviso">
                                    <input type="submit" class="btn btn-success" style="float:right;" value="Enviar aviso">
                                </form>
                            </div>
                        </div>
