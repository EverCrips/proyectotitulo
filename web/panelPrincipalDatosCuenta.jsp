...
<%
    ...
    if (rolUs != null) {
        ...
        String sexoUs = ((String) datosUs.get(2)).trim();
        if (sexoUs.equals("M")) {
            sexoUs = "MASCULINO";
        } else {
            sexoUs = "FEMENINO";
    ...
    <body onload="ejecutarModalFun()">
        ...
        <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Panel personal</li>
                        </ol>
                    </div>
                </div>               
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-xl-3" id="imgPerfilDivPadre">
                        <div class="panel panel-primary" id="imgPerfilDivHija">                           
                            <div class="panel-heading">
                                <div class="row">
                                    <img src="<%=((String) datosUs.get(14)).trim()%>" alt="..." class="img-thumbnail" id="imgPPP"> 
                                </div>
                            </div> 
                           <a data-toggle="modal" data-target="#modalImagen">
                                <div class="panel-footer" id="cambiarImg" title="Modificar imagen">
                                    <span class="center-block">>>Actualizar<<</span>
                            ...
                            <div class="panel-body datosCuenta">
                                ...
                                <div class="row ">                                    
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(0)).trim()%>" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,100}" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Rut</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(1)).trim()%>" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Sexo</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        ...
                                        <input type="email" class="form-control" value="<%=((String) datosUs.get(3)).trim()%>" disabled>                                        
                                    </div> 
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Fono fijo</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(4)).trim()%>" pattern="[0-9]{2}\s?[0-9]{6}" title="Si no posee, rellenar con 00 000000" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Teléfono celular</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(5)).trim()%>" pattern="[(]\d{3}[\)]\s\d{8}" disabled>
                                    </div>
                                </div>
                                <hr>
                                <!-- DATOS 3 -->
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 paddingDiv">
                                        ...
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(6)).trim()%>" disabled>
                                    </div>
                                </div>
                                <hr>
                                <!-- DATOS 4 -->
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Ciudad</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(7)).trim()%>" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Región</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(8)).trim()%>" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Comuna</label>
                                        <input type="text" class="form-control" value="<%=((String) datosUs.get(9)).trim()%>" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Empresa</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosUs.get(10)).trim()%>" disabled>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Equipo</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosUs.get(15)).trim()%>" disabled>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Cargo</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosUs.get(11)).trim()%>" disabled>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Rol</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosUs.get(12)).trim()%>" disabled>
                                            </div>
                                        </div>
                                        <hr>    
                                    </div>
            ...
            <div class="modal fade" id="modalEditDatos" tabindex="-1" role="dialog" aria-labelledby="modalEditDatos" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <form method="post" action="sesionServlet" class="datosCuenta">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="row ">                                    
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Nombre</label>
                                                                <input id="nombreUs" name="nombreUs" type="text" class="form-control" value="<%=((String) datosUs.get(0)).trim()%>" disabled="">
                                                            </div>
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Rut</label>
                                                                <input id="rutUs" name="rutUs" type="text" class="form-control" required value="<%=((String) datosUs.get(1)).trim()%>" disabled="">                       
                                                            </div>
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Sexo</label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Correo electrónico</label>
                                                                <input id="emailUs" name="emailUs" type="email" class="form-control" value="<%=((String) datosUs.get(3)).trim()%>" required>  
                                                                <i class="fas fa-check-circle" id="checkEmail"></i>
                                                                <i class="fas fa-times-circle" id="nocheckEmail"></i>
                                                            </div> 
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Fono fijo</label>
                                                                <input id="fonofijoUs" name="fonofijoUs" type="text" class="form-control" value="<%=((String) datosUs.get(4)).trim()%>" title="Si no posee, rellenar con 00 000000" required>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Teléfono celular</label>
                                                                <input id="telefonocelularUs" name="telefonocelularUs" type="text" class="form-control" value="<%=((String) datosUs.get(5)).trim()%>" required>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Dirección</label>
                                                                <input id="direccionUs" name="direccionUs" type="text" class="form-control" value="<%=((String) datosUs.get(6)).trim()%>" required>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Ciudad</label>
                                                                <input id="ciudadUs" name="ciudadUs" type="text" class="form-control"  value="<%=((String) datosUs.get(7)).trim()%>" required>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Región</label>
                                                                <select id="regionUs" name="regionUs" class="form-control"></select> 
                                                                <input id="regionUsEditActual" type="hidden" class="form-control" value="<%=((String) datosUs.get(8)).trim()%>">
                                                            </div>
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Comuna</label>
                                                                <select id="comunaUs" name="comunaUs" class="form-control"></select>
                                                                <input id="comunaUsEditActual" type="hidden" class="form-control" value="<%=((String) datosUs.get(9)).trim()%>">
                                                            </div>
                                                        </div>    
                                                    </div>
                                                </div>                                              
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="opcion" value="modificarDatosDatos">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="post" action="sesionServlet" class="datosCuenta">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="opcion" value="modificarDatosPass">
                                <input type="hidden" name="emailUsActual" value="<%=((String) datosUs.get(3)).trim()%>">
                                <input type="submit" class="btn btn-success" value="Guardar cambios">
                            </div>
                        </form>                                       
            ...
            <div class="modal fade" id="modalImagen" tabindex="-1" role="dialog" aria-labelledby="modalImagen" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="post" action="sesionServlet" enctype="multipart/form-data">
                            <div class="modal-header">
                                            ...
                                            <div class="panel-heading">
                                                <div class="row">
                                                    <label for="imagenPerfilUser">
                                                        <img id="preview" src="<%=((String) datosUs.get(14)).trim()%>" alt="..." class="img-thumbnail"> 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
