...
<%
    ...
    if (rolUs != null) {
        if (rolUs.equals("ADMINISTRADOR") || rolUs.equals("SUPERVISOR")) {
            ...
            ArrayList datosTrabajadores = (ArrayList) sesion.getAttribute("datosTrabajadores");
...
<html>
    ...
    <body onload="ejecutarModalFun()">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Panel personal - Gestión personal</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-xl-6">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                Panel de perosnal, ¡gestionar ahora!
                            </div>
                            <div class="panel-body">
                                <ul style="list-style-type:circle;">
                                    <li>Crear nuevos trabajadores</li>
                                    <li>Visualizar sus datos</li>
                                    <li>Desactivar trabajadores</li>
                                    <li>Reingresar trabajadores</li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-xl-6">
                        <div class="panel panel-green">
                            ...
                            <div class="panel-body" id="containerCharTra">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <i class="fas fa-user-circle"></i>  Trabajadores Tekonn
                                ...
                                <div class="table-wrapper">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover" id="UsuariosActivos" style="width:100%;">
                                            ...
                                            <tbody>
                                                <%
                                                    if (datosTrabajadores.get(0) == "null") {
                                                %>
                                                <tr>
                                                ...
                                                <%
                                                    ...
                                                    int i = 0,
                                                            aux = 1;
                                                    while (i < datosTrabajadores.size()) {
                                                        String estado = (String) datosTrabajadores.get(i + 1);
                                                        if (estado.equals("1")) {
                                                            estado = "Activo";
                                                %>
                                                <tr>                                                               
                                                    <td><%=((String) datosTrabajadores.get(i)).trim()%></td>
                                                    <td><%=((String) datosTrabajadores.get(i + 2)).trim()%></td>
                                                    <td><%=((String) datosTrabajadores.get(i + 9)).trim()%></td>
                                                    <td><%=((String) datosTrabajadores.get(i + 4)).trim()%></td>
                                                    <td><%=((String) datosTrabajadores.get(i + 11)).trim()%></td>
                                                    <td><%=((String) datosTrabajadores.get(i + 13)).trim()%></td>  
                                                    <td><%=estado%></td>  
                                                    <td>
                ...
                <div class="modal-content">
                    <form method="post" action="servletPU" class="datosCuenta">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="opcion" value="crearNuevoTrabajador">
                        </div>
            ...
            <div class="modal-dialog" id="meu" style="max-width: 400px;">
                <div class="modal-content">
                    <form method="post" action="servletPU" class="datosCuenta">
                        ...
                        <input type="hidden" name="opcion" value="eliminarTrabajador">
                        <div class="modal-footer">
            ...
            <div class="modal-dialog" id="meu" style="max-width: 400px;">
                <div class="modal-content">
                    <form method="post" action="servletPU" class="datosCuenta">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <p>¿Está seguro que desea reingresar al siguiente trabajador?</p>
                                <hr>
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">                                               
                        ...
                        <input type="hidden" name="opcion" value="reactivarTrabajador">
                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Salir">
        ...
        <form method="post" action="servletPU" name="mostrarDatosUsuarioPagNew" id="mostrarDatosUsuarioPagNew">
            <input type="hidden" name="opcion" value="mostrarDatosTrabajadorPagNew">
