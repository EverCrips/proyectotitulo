...
<%
    ...
    if (rolUs != null) {
        if (rolUs.equals("ADMINISTRADOR") || rolUs.equals("SUPERVISOR")) {
            ...
            ArrayList datosTrabajadoresEdit = (ArrayList) sesion.getAttribute("datosTrabajadoresEdit");
            ArrayList datosCargos = (ArrayList) sesion.getAttribute("datosCargos");
            String nombreUs = (String) datosTrabajadoresEdit.get(0);
            String cargoUs = (String) datosTrabajadoresEdit.get(12);

            String sexoUs = ((String) datosTrabajadoresEdit.get(2)).trim();
            if (sexoUs.equals("M")) {
                sexoUs = "MASCULINO";
            } else {
                sexoUs = "FEMENINO";
...
<html>
    <head>
        ...
        <title>Edición trabajador</title>
    ...
    <body onload="ejecutarModalFun()">
        ...
        <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="moduloPersonal.jsp">Panel trabajador - Gestión trabajadores</a>
                            </li>
                            <li class="breadcrumb-item active">Panel trabajador - Edición trabajador</li>
                        </ol>
                    </div>
                </div>               
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 col-xl-3" id="imgPerfilDivPadre">
                        <div class="panel panel-primary" id="imgPerfilDivHija">                           
                            <div class="panel-heading">
                                <div class="row">
                                    <img src="<%=((String) datosTrabajadoresEdit.get(14)).trim()%>" alt="..." class="img-thumbnail" id="imgPPP"> 
                                </div>
                            </div> 
                            ...
                            <div class="panel-body datosCuenta" >
                                ...
                                <div class="row ">                                    
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(0)).trim()%>" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,100}" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Rut</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(1)).trim()%>" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Sexo</label>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        ...
                                        <input type="email" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(3)).trim()%>" disabled>                                        
                                    </div> 
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Fono fijo</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(4)).trim()%>" pattern="[0-9]{2}\s?[0-9]{6}" title="Si no posee, rellenar con 00 000000" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Teléfono celular</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(5)).trim()%>" pattern="[(]\d{3}[\)]\s\d{8}" disabled>
                                    </div>
                                </div>
                                <hr>
                                <!-- DATOS 3 -->
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 paddingDiv">
                                        ...
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(6)).trim()%>" disabled>
                                    </div>
                                </div>
                                <hr>
                                <!-- DATOS 4 -->
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Ciudad</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(7)).trim()%>" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Región</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(8)).trim()%>" disabled>
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                        <label>Comuna</label>
                                        <input type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(9)).trim()%>" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Empresa</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosTrabajadoresEdit.get(10)).trim()%>" disabled>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Equipo</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosTrabajadoresEdit.get(15)).trim()%>" disabled>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Cargo</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosTrabajadoresEdit.get(11)).trim()%>" disabled>
                                            </div>
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                <label>Rol</label>
                                                <input type="text" class="form-control" required value="<%=((String) datosTrabajadoresEdit.get(12)).trim()%>" disabled>
                                            </div>
                                        </div>
                                        <hr>    
                                    </div>
                    ...
                    <div class="modal-content">
                        <form method="post" action="servletPU" class="datosCuenta"> 
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="row ">                                    
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Nombre</label>
                                                                <input id="nombreUsEdit" name="nombreUsEdit" type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(0)).trim()%>"required="">
                                                            </div>
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Rut</label>
                                                                <input id="rutUs" name="rutUsEdit" type="text" class="form-control" required value="<%=((String) datosTrabajadoresEdit.get(1)).trim()%>">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Correo electrónico</label>
                                                                <input id="emailUs" name="emailUsEdit" type="email" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(3)).trim()%>" required>  
                                                                <i class="fas fa-check-circle" id="checkEmail"></i>
                                                                <i class="fas fa-times-circle" id="nocheckEmail"></i>
                                                            </div> 
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Fono fijo</label>
                                                                <input id="fonofijoUs" name="fonofijoUsEdit" type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(4)).trim()%>" title="Si no posee, rellenar con 00 000000" required>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4 paddingDiv">
                                                                <label>Teléfono celular</label>
                                                                <input id="telefonocelularUs" name="telefonocelularUsEdit" type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(5)).trim()%>" required>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Dirección</label>
                                                                <input id="direccionUsEdit" name="direccionUsEdit" type="text" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(6)).trim()%>" required>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Ciudad</label>
                                                                <input id="ciudadUsEdit" name="ciudadUsEdit" type="text" class="form-control"  value="<%=((String) datosTrabajadoresEdit.get(7)).trim()%>" required>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                ...
                                                                <input id="regionUsEditActual" type="hidden" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(8)).trim()%>">
                                                            </div>
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                <label>Comuna</label>
                                                                <select id="comunaUs" name="comunaUsEdit" class="form-control"></select>
                                                                <input id="comunaUsEditActual" type="hidden" class="form-control" value="<%=((String) datosTrabajadoresEdit.get(9)).trim()%>">
                                                            </div>
                                                        </div>    
                                                    </div>
                                                </div>                                              
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="opcion" value="modificarTraSistemaDatos">
                                <input type="hidden" name="emailUsActualEdit" value="<%=((String) datosTrabajadoresEdit.get(3)).trim()%>">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="post" action="servletPU" class="datosCuenta">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                ...
                                                                <select id="empresaUsEdit" name="empresaUsEdit" class="form-control">
                                                                    <option selected="true" value="<%=((String) datosTrabajadoresEdit.get(10)).trim()%>"><%=((String) datosTrabajadoresEdit.get(10)).trim()%></option>
                                                            ...
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">                                                
                                                                <label>Equipo</label>
                                                                <input type="text" class="form-control" id="eq" name="eq" required value="<%=((String) datosTrabajadoresEdit.get(15)).trim()%>" disabled>
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        <div class="row">
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                ...
                                                                <select id="cargoUsEdit" name="cargoUsEdit" class="form-control">
                                                                    <option selected="true" value="<%=((String) datosTrabajadoresEdit.get(11)).trim()%>"><%=((String) datosTrabajadoresEdit.get(11)).trim()%></option>
                                                            ...
                                                            <div class="col-xs-12 col-sm-6 col-md-6 col-xl-6 paddingDiv">
                                                                ...
                                                                <select id="rolUsEdit" name="rolUsEdit" class="form-control">
                                                                    <option selected="true" value="<%=((String) datosTrabajadoresEdit.get(12)).trim()%>"><%=((String) datosTrabajadoresEdit.get(12)).trim()%></option>
                                                                    <option value="CAPATAZ">CAPATAZ</option>
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="opcion" value="modificarTraSistemaDatosSistema">
                                <input type="hidden" name="emailUsActualEdit" value="<%=((String) datosTrabajadoresEdit.get(3)).trim()%>">
                                <input type="hidden" name="emailUsActual" value="<%=((String) datosUs.get(3)).trim()%>">
                                <input type="submit" class="btn btn-success" value="Guardar cambios">
                            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="post" action="servletPU" class="datosCuenta">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="opcion" value="modificarTraSistemaPass">
                                <input type="hidden" name="emailUsActualEdit" value="<%=((String) datosTrabajadoresEdit.get(3)).trim()%>">
                                <input type="hidden" name="emailUsActual" value="<%=((String) datosUs.get(3)).trim()%>">
                                <input type="submit" class="btn btn-success" value="Guardar cambios">
                            </div>
            ...
            <div class="modal fade" id="modalImagen" tabindex="-1" role="dialog" aria-labelledby="modalImagen" aria-hidden="true" data-backdrop="static">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="post" action="servletPU" enctype="multipart/form-data">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edición imagen perfil</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12" id="imgPerfilDivPadre">
                                        <div class="panel panel-primary" id="imgPerfilDivHijaChange">                           
                                            <div class="panel-heading">
                                                <div class="row">
                                                    <label for="imagenPerfilUser">
                                                        <img id="preview" src="<%=((String) datosTrabajadoresEdit.get(14)).trim()%>" alt="..." class="img-thumbnail"> 
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-footer">
                                <input type="hidden" name="opcion" value="modificarDatosImagen">
                                <input type="hidden" name="emailUsActual" value="<%=((String) datosTrabajadoresEdit.get(3)).trim()%>">
                                <input type="file" style="display:none" id="imagenPerfilUser" name="imagenPerfilUser" accept="image/*">
                                <input type="submit" class="btn btn-success" value="Guardar cambios">
                            </div>
                        </form>                                       
                    </div>
